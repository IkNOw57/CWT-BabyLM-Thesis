#!/bin/bash -l
#SBATCH -J VGLUE_evaluation_b12_10000stp
...
srun python $HOME/Thesis-Git/headless-lm/glue_finetuning_unpublished.py --model_ckpt $HOME/Thesis-Git/headless-lm/vanilla_MLM_b12/vanilla_MLM_b12/epoch=18-step=10000.ckpt --mode mlm --train_batch_size 12 --run_name vanilla_10M_MLM-b12
