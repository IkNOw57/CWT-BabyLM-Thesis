#!/bin/bash -l
#SBATCH -J VGLUE_evaluation_100M_b12_20e
...
srun python $HOME/Thesis-Git/headless-lm/glue_finetuning_unpublished.py --model_ckpt $HOME/Thesis-Git/headless-lm/vanilla_MLM_b12_100M_t2/vanilla_MLM_b12_100M_t2/epoch=20-step=110000.ckpt --mode mlm --train_batch_size 12 --run_name vanilla_MLM-b12_100M
