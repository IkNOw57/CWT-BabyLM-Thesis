#!/bin/bash -l
# SLURM submission script template for gpt_headless.py.
# Submit from the repository root with: sbatch scripts/gpt_headless.sh
# Fill in the placeholder <...> values and adjust #SBATCH directives /
# module versions to match your cluster before running.
#SBATCH -J gpt_headless
...
srun python scripts/gpt_headless.py \
