...
srun python $HOME/Thesis-Git/headless-lm/glue_finetuning_unpublished.py --model_ckpt $HOME/Thesis-Git/headless-lm/HGPT-70M-ft/GPT_headless_ft_10e/epoch=1-step=10000.ckpt --mode lm --train_batch_size 12 --run_name HGPT-b12-70M
