#!/bin/bash -l
#SBATCH -J GLUE_evaluation_100M_b12_10e
...
srun python $HOME/Thesis-Git/headless-lm/glue_finetuning_unpublished.py --model_ckpt $HOME/Thesis-Git/headless-lm/HMLM_b12_100M/HMLM_b12_100M/epoch=10-step=55000.ckpt --mode mlm --train_batch_size 12 --run_name HMLM-b12_100M
