#!/bin/bash -l
#SBATCH -J GLUE_evaluation_b12_5000stp
...
srun python $HOME/Thesis-Git/headless-lm/glue_finetuning_unpublished.py --model_ckpt $HOME/Thesis-Git/headless-lm/HMLM_b12/HMLM_b12/epoch=9-step=5000.ckpt --mode mlm --train_batch_size 12 --run_name HMLM-b12
