...
srun python $HOME/Thesis-Git/headless-lm/glue_finetuning_unpublished.py --model_ckpt $HOME/Thesis-Git/headless-lm/HGPT-b12-70M/HGPT-b12-70M/VGPT-epoch=10-step=55000.ckpt --mode lm --train_batch_size 12 --run_name VGPT-b12-70M
